...
var pay = function pay() {
  Payjp.setPublicKey("pk_test_59e90e2d98dfec6596f5b073"); // 公開鍵を設定

  var form = document.getElementById("charge-form"); // 要素取得

  form.addEventListener("submit", function (e) {
    // eにはイベントに関する情報が格納されてる状態
    e.preventDefault(); // 通常のrailsにおけるフォーム送信処理はキャンセルされる

    var formResult = document.getElementById("charge-form"); // 要素取得

    var formData = new FormData(formResult); // FormDataはフォームに入力された値を取得できるオブジェクト
    ...
    Payjp.createToken(card, function (status, response) {
      ...
      if (status == 200) {
        ...
        // 上手くいったとき
        var token = response.id; // トークンの値を取得することができます

        var renderDom = document.getElementById("charge-form");
        var tokenObj = "<input value=".concat(token, " type=\"hidden\" name='token'>"); // valueは実際に送られる値なので、params[:name]のように取得できる
        // token情報をブラウザに表示するとショルダーハッキング
        // されそうなので、hidden

        renderDom.insertAdjacentHTML("beforeend", tokenObj); // トークンの値をフォームに埋め込む
      }

      document.getElementById("card-number").removeAttribute("name");
      document.getElementById("card-cvc").removeAttribute("name");
      document.getElementById("card-exp-month").removeAttribute("name");
      document.getElementById("card-exp-year").removeAttribute("name"); // フォームにクレカの情報が残ってるので、クレカの情報を
...
__webpack_require__(/*! ../bgswitcher */ "./app/javascript/bgswitcher.js");

__webpack_require__(/*! ../card */ "./app/javascript/card.js");

__webpack_require__(/*! ./tag */ "./app/javascript/packs/tag.js");

__webpack_require__(/*! ../slide */ "./app/javascript/slide.js");

__webpack_require__(/*! ./preview */ "./app/javascript/packs/preview.js"); //= require rails-ujs
//= require jquery_ujs
...
if (location.pathname.match("drinks/new")) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    console.log("hoge"); // addEventListenerは様々なイベント処理を実行
    // することができるメソッド
    // documentはhtml要素全体
    // DOMContentLoaded"は
    // Webページ読み込みが完了した時に発動
    ...
    var inputElement = document.getElementById("q_name_cont"); // tweets_tag_nameはform_withが自動で生成してくれるid
    // form_withのモデルに渡したインスタンスのスネークケース
    // + 入力する時のカラム名
    // 今回で言うとform_withに渡してるモデルが@drinkで
    // @drinkはnewアクションで@drink = DrinkTagと定義
    ...
    inputElement.addEventListener("keyup", function () {
      // フォームに入力して、キーボードが離されたタイミング
      // で順次イベント発火していく
      var keyword = document.getElementById("q_name_cont").value; // テキストボックスの入力した値を取得
...
jQuery(function ($) {
  $('.slideshow').bgSwitcher({
    images: ['https://images.unsplash.com/photo-1511920170033-f8396924c348?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8Y29mZmVlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=60', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8Y29mZmVlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=60', 'https://images.unsplash.com/photo-1498804103079-a6351b050096?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Nnx8Y29mZmVlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=60', 'https://images.unsplash.com/photo-1493925410384-84f842e616fb?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MjJ8fGNvZmZlZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=60', 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MzF8fGNvZmZlZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=60', 'https://images.unsplash.com/photo-1531590878845-12627191e687?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MzJ8fGNvZmZlZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1400&q=60'],
...
/******/ });
//# sourceMappingURL=application-1681db46ffc4ef6f4801.js.map