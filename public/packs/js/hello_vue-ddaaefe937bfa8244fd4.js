            ...
            _c("table", { staticClass: "item-category" }, [
              _c("tbody", [
                _c("tr", { staticClass: "item-region" }, [
                  ...
                  _vm._v(" "),
                  _vm.drink.region_id === 1
                    ? _c("td", { staticClass: "region-name" }, [_vm._v("--- ")])
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.drink.region_id === 2
                    ? _c("td", { staticClass: "region-name" }, [
                        _vm._v("マルチリージョン ")
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.drink.region_id === 3
                    ? _c("td", { staticClass: "region-name" }, [
                        _vm._v("ラテンアメリカ ")
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.drink.region_id === 4
                    ? _c("td", { staticClass: "region-name" }, [
                        _vm._v("アフリカ")
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.drink.region_id === 5
                    ? _c("td", { staticClass: "region-name" }, [
                        _vm._v("アジア、太平洋 ")
                      ])
                    : _vm._e()
...
/******/ });
//# sourceMappingURL=hello_vue-ddaaefe937bfa8244fd4.js.map