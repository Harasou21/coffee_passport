...
//
//
vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"].use(window["vue-js-modal"]);





vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"].use(vue_js_modal__WEBPACK_IMPORTED_MODULE_4___default.a);
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    show: function show() {
      this.$modal.show('display-drink-show');
    },
    hide: function hide() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.setDrink(); // this.setRegion();
  },
  methods: {
    setDrink: function setDrink() {
      var _this = this;

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api' + location.pathname).then(function (response) {
        return _this.drink = response.data;
      });
    },
    // setRegion: function(){
      ...
      _c("div", { staticClass: "item-contents" }, [
        ...
        _c(
          ...
          _vm._l(_vm.drinks, function(drink) {
            return _c("li", { key: drink.id, staticClass: "list" }, [
                ...
                _c("div", { staticClass: "item-explain" }, [
                  _vm._v(
                    "\n                " +
                      ...
                      "\n                " +
                      _vm._s(drink.region_id) +
                      "\n                " +
                      _vm._s(drink.body_id) +
                      "\n                " +
                      _vm._s(drink.acidity_id) +
                      "\n              "
                  )
                ]),
                _vm._v(" "),
...
/******/ });
//# sourceMappingURL=hello_vue-c63da4d890810a2506d1.js.map