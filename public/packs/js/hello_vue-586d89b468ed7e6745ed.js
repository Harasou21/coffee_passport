  ...
  methods: {
    setDrink: function setDrink() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/api/drinks').then(function (response) {
        return response.data.forEach(function (drink) {
          return _this.fetchLikeByDrinkId(drink);
        });
      });
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log(drink); // rails側のcreateアクションにリクエストするメソッド
                    ...
                    _vm.isLiked
                      ...
                      : _c(
                          "div",
                          {
                            on: {
                              click: function($event) {
                                return _vm.registerLike(drink.id)
                              }
                            }
                          },
                          [
...
/******/ });
//# sourceMappingURL=hello_vue-586d89b468ed7e6745ed.js.map