...
/* harmony import */ var _packs_components_like_likeButton_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./packs/components/like/likeButton.vue */ "./app/javascript/packs/components/like/likeButton.vue");
/* harmony import */ var _packs_components_drinks_show_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./packs/components/drinks/show.vue */ "./app/javascript/packs/components/drinks/show.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    likeButton: _packs_components_like_likeButton_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    drinkShow: _packs_components_drinks_show_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      drinks: "drinks",
  ...
  created: function created() {// vueインスタンスの作成、初期化直後に実行される
  },
  ...
  methods: {
    setDrink: function setDrink() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/api/drinks').then(function (response) {
        return _this.drinks = response.data;
      });
    },
    displayAllLikes: function displayAllLikes() {
      var _this2 = this;

      this.drinks.forEach(function (drink) {
        return _this2.fetchLikeByDrinkId(drink).then(function (result) {
          console.log(result); // this.likeList = result
        });
      });
    },
    ...
    fetchLikeByDrinkId: function () {
      var _fetchLikeByDrinkId = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(drink) {
        var response;
      ...
      function fetchLikeByDrinkId(_x) {
    ...
    registerLike: function () {
      var _registerLike = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(drink) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                this.fetchLikeByDrinkId(drink).then(function (result) {
                  _this3.likeList = result;
                });
    ...
    deleteLike: function () {
      var _deleteLike = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(drink) {
        var likeId, response;
          ...
          return _c(
            ...
            [
              ...
              _c("div", { staticClass: "item-info" }, [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "like-and-comment" }, [
                  _c("div", [
                    _vm.isLiked
                      ? _c(
                          "div",
...
/******/ });
//# sourceMappingURL=hello_vue-54613e4f2f9a747dd4dd.js.map