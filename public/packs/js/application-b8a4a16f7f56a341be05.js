...
if (document.URL.match(/drinks/)) {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('drink_tag_image').addEventListener('change', function (e) {
      ...
      var imageContent = document.getElementById('image-list');
      ...
      blobImage.setAttribute('src', blob); // => <div><input></div>
...
/******/ });
//# sourceMappingURL=application-b8a4a16f7f56a341be05.js.map